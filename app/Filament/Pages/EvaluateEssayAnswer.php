        ...
        return $table
            ...
            ->query(
                ParticipantAssessment::query()
                    ...
                    ->when($this->filterFormData['group_id'], fn($q, $v) => $q->whereHas('participant.participantGroup', fn($q) => $q->where('group_id', $v)))
                    ...
                    ->when(
                        $this->filterFormData['assessment_id'],
                        fn($q, $v) => $q->where('assessment_id', $v)
                    )
            )
            ->columns([
